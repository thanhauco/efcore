    ...
    public abstract class ExecutionStrategy : IExecutionStrategy
    {
        ...
        public static TResult CallOnWrappedException<TResult>(
            ...
            => exception is DbUpdateException dbUpdateException
                // TODO-NULLABLE: Looks like we pass null InnerException here, though CallOnWrappedException annotates non-nullable -
                // but concrete implementations are OK with it. Have annotated to allow null exception, we can also return default here
                // instead.
